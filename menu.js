...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "eg-08", name: "黃金泡菜鮪魚", nameEn: "", price: 50, modifierGroups: ["eggPancakeBase"], addons: EGG_PANCAKE_CHEESE_ADDON },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "cr-10", name: "巧克力", nameEn: "", price: 50, modifierGroups: ["cheeseEgg"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sn-06", name: "薯餅", nameEn: "", price: 25 },
